...
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("discord --disable-gpu"))
...
-- Bind workspaces 1-10 to DP-1 (was: workspace = N, monitor:DP-1, default:true)
for i = 1, 10 do
	hl.workspace_rule({ workspace = tostring(i), monitor = "DP-1", default = true })
end

-- Second monitor workspaces (11-20) -- enable when HDMI-A-1 is active
-- for i = 11, 20 do
